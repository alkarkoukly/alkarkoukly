...
- [Knowledge bases and software support for variant interpretation in precision oncology](https://pubmed.ncbi.nlm.nih.gov/34125166/)  
...
- [Breaking Barriers for Interoperability: A Reference Implementation of CSV-FHIR Transformation Using Open-Source Tools](https://pubmed.ncbi.nlm.nih.gov/37203606/)  
...
- [An openEHR Virtual Patient Template for Pancreatic Cancer](https://pubmed.ncbi.nlm.nih.gov/34734890/)  
...
- [An ontology-based rare disease common data model harmonising international registries, FHIR, and Phenopackets](https://pubmed.ncbi.nlm.nih.gov/39922817/)  
...
- [Risk Factors for Re-treatment After Keratorefractive Lenticule Extraction (KLEx) for Myopia and Myopic Astigmatism](https://pubmed.ncbi.nlm.nih.gov/38848058/)  
...
- [Retreatment after keratorefractive lenticule extraction (KLEx): Results of various methods and influence of the recommendations of the Committee for Refractive Surgery (KRC) on the incidence of retreatment](https://pubmed.ncbi.nlm.nih.gov/40323398/)  
...
- [Linking international registries to FHIR and Phenopackets with RareLink: a scalable REDCap-based framework for rare disease data interoperability](https://pubmed.ncbi.nlm.nih.gov/40385395/)  
...
- [Seeing the primary tumor because of all the trees: Cancer type prediction on low-dimensional data](https://pubmed.ncbi.nlm.nih.gov/39257886/)  
...
- [An OpenEHR Template with the Integrated German LOINC Terms](https://pubmed.ncbi.nlm.nih.gov/34042864/)  
